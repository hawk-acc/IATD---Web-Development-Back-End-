...
const courses = [
    {
      ...
      brief:'Learn the fundamentals of data analytics and how to transform raw data into meaningful insights for better decision-making.',
      ...
      hours: 70,
      modules: ['Introduction to Data Analytics',
                'Understanding Data Types and Sources',
                'Data Cleaning and Preparation',
                'Exploratory Data Analysis',
                'Data Visualization Fundamentals',
                'Introduction to Analytical Tools (Excel, Python, or BI Tools)',
    ...
    },
    {
      ...
      brief:'Understand the core strategies of digital marketing including SEO, social media, content marketing, and online advertising.',
      ...
      hours: 60,
      modules: ['Introduction to Digital Marketing',
    ...
    },
    {
      ...
      brief:'Develop practical project management skills to plan, execute, and deliver projects successfully.',
      ...
      hours: 60,
      modules: ['Introduction to Project Management',
